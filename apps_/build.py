...
def build_all():
    ...
    os.system("i686-elf-gcc -nostdlib -w -lgcc -ffreestanding -I include/ -c examples/C/picture.c -o ./bin/picture.o")
    ...
    os.system("i686-elf-gcc -nostdlib -lgcc -T link.ld -o ../bin/apps/picture.elf ./bin/picture.o" + O_LIBC)
